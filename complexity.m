...
M = 1080;
N = 1080;
UnitaryList = {[9, 120], [5, 9, 24], [3, 3, 5, 24], [3, 3, 4, 5, 6], [2, 3, 3, 3, 4, 5], [2, 2 , 2, 3, 3, 3, 5]}; % m_list = [m_1, m_2, ..., m_r] 3\leq m_i\leq 4
% n_list = m_list;
% n_list = [];
% for i=1:r
